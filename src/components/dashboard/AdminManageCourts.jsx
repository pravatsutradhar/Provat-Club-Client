  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-xl mx-auto my-4">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="courtName">Name</label>
          <input type="text" id="courtName" className="form-input" value={name} onChange={(e) => setName(e.target.value)} required />
        </div>
        <div>
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="courtType">Type</label>
          <select id="courtType" className="form-input" value={type} onChange={(e) => setType(e.target.value)} required>
        ...
        <div>
          ...
          <input type="number" id="pricePerSession" className="form-input" value={pricePerSession} onChange={(e) => setPricePerSession(e.target.value)} required min="0" step="0.01" />
        </div>
        <div>
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="capacity">Capacity</label>
          <input type="number" id="capacity" className="form-input" value={capacity} onChange={(e) => setCapacity(e.target.value)} required min="1" />
        </div>
        <div className="md:col-span-2">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="description">Description</label>
          <textarea id="description" className="form-input" value={description} onChange={(e) => setDescription(e.target.value)} rows="3" maxLength="500"></textarea>
        </div>
